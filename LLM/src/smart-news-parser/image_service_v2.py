...
class ImageServiceV2:
    ...
    async def _generate_prompt(self, info: ExtractedAnnouncementInfo, has_building_ref: bool) -> str:
        ...
        prompt_system = (
            ...
            "Include 1-2 clear, recognizable thematic objects STRICTLY RELATED to the announcement's actual subject (e.g., stylized sleek train/bus tickets for 'transportation', elegant 3D microchips for 'hardware', glowing code blocks for 'hackathon'). Integrate them elegantly into the background. Ensure these objects are highly detailed, richly colored, and visually striking. Avoid making them look like blank, boring shapes. "
            "INSTRUCTION 2: Keep the composition clean, highly aesthetic, and professional. "
            ...
            "Formal/Administrative events (Transportation, Exams, Grants) → 'sophisticated, premium academic aesthetic, beautiful soft ambient lighting, smooth vibrant corporate gradients (e.g. deep blues, warm golds, or elegant purples), subtle 3D symbolic icons gently floating. Very polished and visually striking but clean and professional.' "
            "INSTRUCTION 4: The final image will be heavily cropped to a 16:9 widescreen ratio. You MUST compose the image panoramically, centering all important focal objects horizontally and leaving generous empty atmospheric space at the top and bottom so nothing gets cut off. "
