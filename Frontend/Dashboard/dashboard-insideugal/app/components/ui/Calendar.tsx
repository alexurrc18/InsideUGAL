  ...
  return (
    <DayPicker
      className={joinClasses(
        "text-foreground [--rdp-accent-color:var(--brand)] [--rdp-accent-background-color:color-mix(in_srgb,var(--brand)_12%,white)] [--rdp-day-height:2.4rem] [--rdp-day-width:2.4rem] [--rdp-day_button-height:2.25rem] [--rdp-day_button-width:2.25rem] [--rdp-day_button-border-radius:0.25rem]",
        className,
      )}
      classNames={{
