  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Noutăți Universitare</h1>
          <p className="text-sm text-muted">Rămâi la curent cu cele mai recente anunțuri și știri din universitate.</p>
        </div>
