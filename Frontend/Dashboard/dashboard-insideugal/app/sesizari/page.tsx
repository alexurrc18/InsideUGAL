...
const initialUsers: UserItem[] = [
  {
    id: "usr-1",
    name: "Răileanu Claudia",
    email: "cr238@student.ugal.ro",
    role: "Admin",
    status: "Activ",
    faculty: "Facultatea de Automatică, Calculatoare, Electrică și Electronică",
...
export default function ConturiPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div>
        <h1 className="text-xl font-bold text-slate-900 tracking-tight">Gestionare Conturi Utilizatori</h1>
        <p className="text-xs text-slate-500">Vizualizează, caută după email instituțional și setează drepturile de acces în InsideUGAL.</p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-4 justify-between items-stretch lg:items-center">
        <div className="relative flex-1 max-w-md">
          <input
            type="text"
            placeholder="Caută după nume sau email (ex: cr238...)"
            value={searchQuery}
