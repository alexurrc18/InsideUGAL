...
export function isFacilityOpen(name: string, date: Date = new Date()): boolean {
  ...
  if (lower.includes('cantina')) {
    if (day >= 1 && day <= 5) {
      if (lower.includes('cămine') || lower.includes('camine')) {
        return timeVal >= 1200 && timeVal <= 1700;
      }
      ...
      if (lower.includes('universitate')) {
        ...
        if (day === 5) {
          return timeVal >= 1200 && timeVal <= 1400;
        }
      }
      return timeVal >= 1200 && timeVal <= 1530;
    }
  ...
  if (lower.includes('cabinet') || lower.includes('medic')) {
    if (day >= 1 && day <= 5) {
      return timeVal >= 700 && timeVal <= 1500;
    }
    return false;
  }
  ...
  if (lower.includes('biblioteca')) {
    if (day >= 1 && day <= 4) {
      return timeVal >= 1230 && timeVal <= 1430;
    }
    if (day === 5) {
      return timeVal >= 1230 && timeVal <= 1330;
    }
    return false;
  }
  ...
  if (lower.includes('consiliere')) {
    if (day >= 1 && day <= 5) {
      return timeVal >= 800 && timeVal <= 1400;
    }
    return false;
  }
