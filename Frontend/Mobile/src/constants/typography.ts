export const Typography = {
  Heading1: { fontSize: 39, fontFamily: "InstrumentSans-Bold", fontWeight: "700" as const },
  Heading2: { fontSize: 31, fontFamily: "InstrumentSans-Bold", fontWeight: "700" as const },
  Heading3: { fontSize: 25, fontFamily: "InstrumentSans-Bold", fontWeight: "700" as const },
  Heading4: { fontSize: 20, fontFamily: "InstrumentSans-Bold", fontWeight: "700" as const },
  Heading5: { fontSize: 16, fontFamily: "InstrumentSans-Bold", fontWeight: "700" as const },
  Heading6: { fontSize: 16, fontFamily: "InstrumentSans-SemiBold", fontWeight: "600" as const },
