...
> Acest document definește standardul de logging pentru toate echipele (Backend, Frontend, LLM).
...
Echipele BE (@andreeac25) și FE trebuie să implementeze acest standard în codul lor.
PR-urile fără logging structurat nu vor fi aprobate după data de 01.06.2026.