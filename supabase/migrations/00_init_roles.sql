...
ALTER ROLE authenticator WITH NOINHERIT LOGIN PASSWORD 'InsideUGALLocalPostgres2026';
ALTER ROLE supabase_auth_admin WITH NOINHERIT LOGIN CREATEROLE CREATEDB PASSWORD 'InsideUGALLocalPostgres2026';
ALTER ROLE supabase_admin WITH NOINHERIT LOGIN SUPERUSER CREATEROLE CREATEDB REPLICATION BYPASSRLS PASSWORD 'InsideUGALLocalPostgres2026';
ALTER ROLE supabase_storage_admin WITH NOINHERIT LOGIN CREATEROLE PASSWORD 'InsideUGALLocalPostgres2026';
