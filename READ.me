...
7. 'git add .' (pentru a incarca toate fisierele noi)
9. (optional) apelezi iar "git status" pt a verifica daca fiserele au fost incarcate (momentan ele sunt incarcate in folderul git-ului de pe pc dar nu si pe net)
10. 'git commit -m "aici adaugi o descriere scurta"
11. 'git push origin main' - asta va trimite modificarile catre git hub
12. (optional) 'git status' -  pt a verifica daca toate fisierele au fost trimise
